...
router.put("/freeze/:id", (0, auth_middleware_1.isAuthenticated)(), comment_service_1.default.freezeComment);
router.put("/unfreeze/:id", (0, auth_middleware_1.isAuthenticated)(), comment_service_1.default.unfreezeComment);
router.delete("/:id", (0, auth_middleware_1.isAuthenticated)(), comment_service_1.default.deleteComment);
router.put("/update/:id", (0, validation_middleware_1.isValid)(comment_validation_1.commentValidation), (0, auth_middleware_1.isAuthenticated)(), comment_service_1.default.updateComment);
